...
int BT5BU_CalcBlockDistance(u64 blk1, u64 blk2)
{
	...
	ctab1[0]=(u16)(blk1>> 0);	ctab1[3]=(u16)(blk1>>16);
	ctab2[0]=(u16)(blk2>> 0);	ctab2[3]=(u16)(blk2>>16);
	...
	byte *codat, int cosz, u64 *blks, int nblks)
{
	...
	while(cs<cse)
	{
		...
		if(eps)
		{
			...
			{	blk1=cs[ncf1];	blk2=blk1|(~0xFFFFFFFFULL);
				if(blk2!=blk1)	break;		}
