...
#define RIFF_TAG_msvc	RIFF_MAKETAG('m','s','v','c')
...
#define RIFF_TAG_zcra	RIFF_MAKETAG('z','c','r','a')
...
#define RIFF_TAG_00dc	RIFF_MAKETAG('0','0','d','c')
#define RIFF_TAG_01wb	RIFF_MAKETAG('0','1','w','b')
...
#define BGBBTJ_FCC_bt5a	RIFF_MAKETAG('b','t','5','a')
#define BGBBTJ_FCC_bt5b	RIFF_MAKETAG('b','t','5','b')

#define BGBBTJ_FCC_zcra	RIFF_MAKETAG('z','c','r','a')
...
#define BGBBTJ_AVI_AUID_11K8BM		(BGBBTJ_AVI_AUID_11K|BGBBTJ_AVI_AUID_8BM)
#define BGBBTJ_AVI_AUID_16K8BM		(BGBBTJ_AVI_AUID_16K|BGBBTJ_AVI_AUID_8BM)
...
#define BGBBTJ_AVI_AUID_11K8BS		(BGBBTJ_AVI_AUID_11K|BGBBTJ_AVI_AUID_8BS)
...
#define BGBBTJ_AVI_AUID_11K16BM		(BGBBTJ_AVI_AUID_11K|BGBBTJ_AVI_AUID_16BM)
...
#define BGBBTJ_AVI_AUID_11K16BS		(BGBBTJ_AVI_AUID_11K|BGBBTJ_AVI_AUID_16BS)
...
#define BGBBTJ_QFL_PFRAME		256
#define BGBBTJ_QFL_IFRAME		512
#define BGBBTJ_QFL_BATCHENCODE	1024
