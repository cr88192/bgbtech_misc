...
#define		btpic_getu16(p)		btic4b_getu16le(p)
#define		btpic_getu32(p)		btic4b_getu32le(p)
#define		btpic_getu64(p)		btic4b_getu64le(p)

#define		btpic_setu16(p, v)	btic4b_setu16le(p, v)
#define		btpic_setu32(p, v)	btic4b_setu32le(p, v)
#define		btpic_setu64(p, v)	btic4b_setu64le(p, v)
...
//HIC hicd;
void *hicd;
BTIC1H_BMPInfoHeader *ihead;
BTIC1H_BMPInfoHeader *ohead;
void *buffer;
void *vctx;
int clrs;
byte flip;
...
int BTPIC0A_FreeDecodeContext(BTPIC0A_DecodeContext *ctx)
{
	free(ctx);
	return(0);
}
...
void BTPIC0A_DecodeImageBlockRGB(u64 blk, void *dptr, int ystr, int clrs)
{
	...
	{
		clra=clra&0xFF00FF00|((clra<<16)&0x00FF0000)|((clra>>16)&0x000000FF);
		clrb=clrb&0xFF00FF00|((clrb<<16)&0x00FF0000)|((clrb>>16)&0x000000FF);
	}
...
//		ct[0]=t0;	ct[1]=t0;	ct[2]=t0;	ct[3]=t0;
		btic4b_setu24lef(ct+0, t0);		btic4b_setu24lef(ct+3, t0);
		btic4b_setu24lef(ct+6, t0);		btic4b_setu24lef(ct+9, t0);
		ct+=ystr;
//		ct[0]=t0;	ct[1]=t0;	ct[2]=t0;	ct[3]=t0;
		btic4b_setu24lef(ct+0, t0);		btic4b_setu24lef(ct+3, t0);
		btic4b_setu24lef(ct+6, t0);		btic4b_setu24lef(ct+9, t0);
...
//		ct[0]=t0;	ct[1]=t0;	ct[2]=t1;	ct[3]=t1;
		btic4b_setu24lef(ct+0, t0);		btic4b_setu24lef(ct+3, t0);
		btic4b_setu24lef(ct+6, t1);		btic4b_setu24lef(ct+9, t1);
		ct+=ystr;
//		ct[0]=t0;	ct[1]=t0;	ct[2]=t1;	ct[3]=t1;
		btic4b_setu24lef(ct+0, t0);		btic4b_setu24lef(ct+3, t0);
		btic4b_setu24lef(ct+6, t1);		btic4b_setu24lef(ct+9, t1);
		ct+=ystr;
//		ct[0]=t2;	ct[1]=t2;	ct[2]=t3;	ct[3]=t3;
		btic4b_setu24lef(ct+0, t2);		btic4b_setu24lef(ct+3, t2);
		btic4b_setu24lef(ct+6, t3);		btic4b_setu24lef(ct+9, t3);
		ct+=ystr;
//		ct[0]=t2;	ct[1]=t2;	ct[2]=t3;	ct[3]=t3;
		btic4b_setu24lef(ct+0, t2);		btic4b_setu24lef(ct+3, t2);
		btic4b_setu24lef(ct+6, t3);		btic4b_setu24lef(ct+9, t3);
...
//	{
//		BTPIC0A_DecodeImageBlockRGB(blk, dptr, ystr, clrs);
//		return;
//	}
...
void BTPIC0A_DecodeBlockImageRGBX(u32 *dptr, u64 *blka,
	int bxs, int bys, int ystr, int clrs)
{
	u64 *cs, *cse;
	u32 *ct0, *ct1;
...
void BTPIC0A_DecodeBlockImageRGB(byte *dptr, u64 *blka,
	int bxs, int bys, int ystr, int clrs)
{
	u64 *cs, *cse;
	byte *ct0, *ct1;
...
void BTPIC0A_DecodeBlockImage(void *dptr, u64 *blka,
	int bxs, int bys, int ystr, int clrs)
{
	switch(clrs)
	{
	...
	case BTIC4B_CLRS_RGBX:	case BTIC4B_CLRS_BGRX:
		BTPIC0A_DecodeBlockImageRGBX(dptr, blka, bxs, bys, ystr, clrs);
		break;

	case BTIC4B_CLRS_RGB555:
		BTPIC0A_DecodeBlockImageRGB16(dptr, blka, bxs, bys, ystr, clrs);
		break;

	case BTIC4B_CLRS_RGB:
	case BTIC4B_CLRS_BGR:
		BTPIC0A_DecodeBlockImageRGB(dptr, blka, bxs, bys, ystr, clrs);
		break;
...
int BTPIC0A_DecodeFrame(BTPIC0A_DecodeContext *ctx,
	byte *cdat, int csz, void *img, int ystr, int clrs)
{
	u64 *tblk;
...
//			BTPIC0A_DecodeFrame(ctx, ctx->zfbuf, ctx->zfbsz, img, ystr, clrs);
			BTPIC0A_DecodeFrame(ctx, ctx->zfbuf, dsz, img, ystr, clrs);
