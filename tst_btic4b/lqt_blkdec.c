...
//		pxy1=*(u32 *)(blkbuf+16+i*6+3);
		...
		for(j=0; j<4; j++)
		{
			...
			ct0[0]=cb0;		ct0[1]=cg0;		ct0[2]=cr0;
			ct0[4]=cb1;		ct0[5]=cg1;		ct0[6]=cr1;
			ct1[0]=cb2;		ct1[1]=cg2;		ct1[2]=cr2;
			ct1[4]=cb3;		ct1[5]=cg3;		ct1[6]=cr3;
...
void LQTVQ_DecBlock3BGRA(byte *blkbuf, byte *ibuf, int ystr)
{
	...
	acy=*(u16 *)(blkbuf+ 4);	acu=*(u16 *)(blkbuf+ 6);
	acv=*(u16 *)(blkbuf+ 8);	dcy=*(u16 *)(blkbuf+10);
	dcu=*(u16 *)(blkbuf+12);	dcv=*(u16 *)(blkbuf+14);
