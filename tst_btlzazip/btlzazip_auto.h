...
int BTLZA_BitDec_CheckSetupRingHuffTables(BGBBTJ_BTLZA_Context *ctx, int hnrh);
...
void BTLZA_BitEnc_StatLengthsRh(BGBBTJ_BTLZA_Context *ctx,byte *cl, byte *lcl, int nc, int *stat);
...
void BTLZA_BitEnc_EncodeDistanceSymbolBasic(BGBBTJ_BTLZA_Context *ctx, int v);
void BTLZA_BitEnc_EncodeSymbolRingHuff(BGBBTJ_BTLZA_Context *ctx, int v);
void BTLZA_BitEnc_EncodeDistanceSymbolRingHuff(BGBBTJ_BTLZA_Context *ctx, int v);
void BTLZA_BitEnc_EncodeLengths(BGBBTJ_BTLZA_Context *ctx, byte *cl, int nc);
void BTLZA_BitEnc_EncodeLengthsRh(BGBBTJ_BTLZA_Context *ctx, byte *cl, byte *lcl, int nc);
